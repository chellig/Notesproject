                                        ...
                                        <div class="col-lg-8">
                                            <div class="bg-body shadow rounded-pill p-2">
                                                <div class="input-group">
                                                    <input class="form-control border-0 me-1" type="email" placeholder="Entrer votre email">
                                                    <button type="button" class="btn btn-blue mb-0 rounded-pill">Inscrivez-vous!</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
            ...
            <div class="container">
                <div class="row mx-auto">
                    <div class="col-lg-6 mx-auto text-center my-5">
                        <!-- Logo -->
                        <img class="mx-auto h-40px" src="@/assets/images/logo-iit.png" alt="logo">
                        ...
                        <ul class="list-inline mt-3 mb-0">
                            <li class="list-inline-item"> 
                                <a class="btn btn-white btn-sm shadow px-2 text-facebook" href="https://www.facebook.com/iitsfax">
                                    <i class="fab fa-fw fa-facebook-f"></i>
                                </a> 
                            </li>
                            <li class="list-inline-item"> 
                                <a class="btn btn-white btn-sm shadow px-2 text-instagram" href="https://www.instagram.com/iit_sfax/">
                                    <i class="fab fa-fw fa-instagram"></i>
                                </a> 
                            </li>
                            <li class="list-inline-item"> <a class="btn btn-white btn-sm shadow px-2 text-linkedin" 
                                href=" https://www.linkedin.com/uas/login?session_redirect=%2Fcompany%2F34949214%2F">
                                <i class="fab fa-fw fa-linkedin-in"></i></a> </li>
                           
                        </ul>
                        <!-- Bottom footer link -->
                        <div class="mt-3 text-white">©2024 <a href="https://iit.tn/"
                             class="text-reset btn-link text-primary-hover" target="_blank">IIT</a> </div>
                    </div>
                </div>
            </div>
        </footer>  
